...
@section('contents')
    ...
    <form method="POST" action="{{ route('AuthStudents.store') }}" enctype="multipart/form-data" id="profile_setup_frm" >
    <div class="row">
            ...
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="AIUId" class="form-control" placeholder="ID" value="">
                    </div>
                    <div class="col-md-6">
                        <label class="labels">CGPA</label>
                        <input type="text" name="gpa" class="form-control" value="" placeholder="CGPA">
                    </div>
                </div>
