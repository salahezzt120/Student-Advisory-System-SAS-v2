            ...
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="phone" class="form-control" disabled placeholder="Phone Number" value="01221652312">
                    </div>
                    {{-- <div class="col-md-6">
                        <label class="labels">CGPA</label>
                        <input type="text" name="address" class="form-control" value="{{ auth()->user()->address }}" placeholder="CGPA">
                    </div> --}}
                </div>
