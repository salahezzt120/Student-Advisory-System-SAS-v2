          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="{{ route('register.save') }}" method="POST" class="user">
                ...
                <div class="form-group">
                  <input name="gpa" type="text" class="form-control form-control-user @error('gpa')is-invalid @enderror" id="exampleInputGPA" placeholder="GPA">
                  @error('gpa')
                    <span class="invalid-feedback">{{ $message }}</span>
                  @enderror
                </div>
                <div class="form-group">
                  <input name="aiu_id" type="text" class="form-control form-control-user @error('aiu_id')is-invalid @enderror" id="exampleInputAIUID" placeholder="AIU ID">
                  @error('aiu_id')
                    <span class="invalid-feedback">{{ $message }}</span>
                  @enderror
                </div>
